...
# Auto-import all modules in sentra.domain.entities
import sentra.domain.entities
import sentra.domain.enums
for _, module_name, _ in pkgutil.iter_modules(sentra.domain.entities.__path__):
    importlib.import_module(f"sentra.domain.entities.{module_name}")
for _, module_name, _ in pkgutil.iter_modules(sentra.domain.enums.__path__):
    importlib.import_module(f"sentra.domain.enums.{module_name}")
