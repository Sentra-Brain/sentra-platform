# sentra.runtime/mcp/adapters/fastmcp.py
import json
import uuid
import asyncio
...
from sentra.runtime.mcp.ports.mcp import MCPPort
from sentra.runtime.mcp.models import ToolResult, ToolSchema

_PROTOCOL_VERSION = "2025-06-18"

logger = logging.get_logger("sentra.runtime.mcp.fastmcp")
    ...
    async def _ensure_initialized_locked(self, client: httpx.AsyncClient) -> None:
        init_body = {
            ...
            "params": {
                ...
                "capabilities": {},
                "clientInfo": {"name": "sentra-runtime", "version": "0.1.0"},
            },
        }
