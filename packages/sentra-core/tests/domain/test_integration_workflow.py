...
from sentra.domain.services.indexing_publisher import IndexingJobPublisher, create_indexing_job
...
class TestEndToEndWorkflow:
    ...
    def test_complete_upload_workflow(self, temp_mount_path):
        ...
        assert absolute_path.name == "test_document.pdf"

        # ✅ Normalize to POSIX string
        assert Path(relative_path).as_posix() == f"uploads/{user_id}/test_document.pdf"
