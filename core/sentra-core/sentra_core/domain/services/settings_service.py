# sentra_core/domain/services/settings_service.py
...
from sentra_core.domain.repository.system_settings_repository import SystemSettingsRepository
from sentra_core.domain.repository.chat_settings_repository import ChatSettingsRepository
