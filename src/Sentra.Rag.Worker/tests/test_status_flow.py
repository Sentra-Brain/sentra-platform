...
def test_document_status_enum():
    ...
    try:
        from sentra.domain.entities.document_entity import DocumentStatus
...
def test_simple_logging():
    ...
    try:
        from sentra.shared.logging import get_logger, set_request_id, get_request_id, configure_logging
